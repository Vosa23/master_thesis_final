...
class Client():
    def __init__(self,H=None,p=None,i=None,e=None,t=None,s=None,d=None,
        ...
        rendering=True, damage=False, lap_limiter=10, recdata=False,
        noisy=False, rec_index=0, rec_episode_limit=1, rec_timestep_limit=3600,
        rank=0, trackname=None):

        log = logging.getLogger(__name__)
        log.info('init Client object started')
        print('LOGGING init Client object started - snakeOil Client')
        ...
        self.port = 3000 + rank
        self.sid= 'SCR'
        self.maxEpisodes=10 # "Maximum number of learning episodes to perform"
        self.trackname= trackname #'unknown' DVO
        self.stage= 3 # 0=Warm-up, 1=Qualifying 2=Race, 3=unknown <Default=3>
        self.debug= False
        self.maxSteps= 100000000000  # 50steps/second    #1000000000 
        ...
        while True:
            ...
            try:
                ...
                if n_fail < 0:
                    ...
                    print("LOGGING: torcs -nofuel ( snakeOil.setup_connection() except block ).")
                    ...
                    if self.trackname is not None:
                        args.append( '-track ' + str(self.trackname) )
    ...
    def parse_the_command_line(self):
        try:
            ...
            sys.exit(-1)
        try:
            print("LOGGING:SNAKEOIL - parsing args --track, --host etc..parse_the_command_line()  ).")
            for opt in opts:
